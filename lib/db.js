...
/**
 * Ensure players match rtypeweb shared shape.
 * Does NOT create/own scores — game repos (e.g. rtypeweb) bootstrap that table
 * so the portal cannot lock in a conflicting DDL on empty shared Turso.
 */
